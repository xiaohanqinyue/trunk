    ...
    <nav class="white nav1">
        <div class="nav-wrapper">
            <a href="<%=basePath%>goods/homeGoods" class="logo">
                <em class="em1">内蒙古大学</em>
                <em class="em2">二手交易网</em>
                <em class="em3">imu.market</em>
            </a>
            <div class="nav-wrapper search-bar">
                <form ng-submit="search()" class="ng-pristine ng-invalid ng-invalid-required" action="/goods/search">
                    <div class="input-field">
                        <input id="search" name="str" placeholder="请输入搜索的商品..." style="height: 40px;"
                    ...
                    <li class="changemore">
                        ...
                        <div class="more-vert">
                            <ul class="dropdown-content">
                                ...
                                <li><a>消息</a></li>
                                <li><a onclick="ChangeName()">更改密码</a></li>
            ...
            <div class="row">
                ...
                <form:form action="/user/login" method="post" commandName="user" role="form">
                    ...
                    <div class="input-field col s12">
                        ...
                        <label>密码</label>
                        <a  href="#" id="forget" class="forget-btn">忘记密码？</a>
                    </div>
    ...
    <div id="changeName" class="change-name stark-components">
        <div class="publish-box z-depth-4">
            <div class="row">
                ...
                <form:form action="/user/changePassword" method="post" commandName="user" role="form">
                    <div class="input-field col s12">
                    ...
                    <a href="">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎来到内蒙古大学Squirrel校园二手交易网。</p>
                                <p class="text3">你是否有很多的闲置与校友分享，为了追求更好的校园服务，</p>
                                <p class="text4">我们打造了一个全新的校园平台——<span>Squirrel二手交易网</span></p>
